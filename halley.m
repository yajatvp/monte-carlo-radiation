...
Te(t+1)=(sc(t+1)/(4*0.96*sigma))^0.25;
end

plot(Te);grid on; xlim([0,365]);%ylim([300,310]);
title("Average temperature variation of Halley's comet for 1 revolution");
ylabel('Average surface Temperature [K]'); xlabel('Day out of 365');
